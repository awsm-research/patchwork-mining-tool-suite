...
| original_id | A combination of endpoint type, item type, and original Django id presented in the api data, e.g. `ffmpeg-people-1`; Note that for maintainer accounts of a project, the item type will become `user`, e.g. `ffmpeg-user-1` |
...
| _id         | Object id created by MongoDB |
| id          | Auto-increment id generated by Django |
| original_id | A combination of endpoint type, item type, and an auto-generated index, e.g. `ffmpeg-individual-1` |
...
| change1  | Referencing the `original_id ` in the changes1 collection (change sets generated by grouping step 1 |
| change2  | Referencing the `original_id ` in the changes2 collection (change sets generated by grouping step 2 |
...
| _id         | Object id created by MongoDB |
| id          | Auto increment id generated by Django |
| original_id | A combination of endpoint type, item type, and an auto-generated index, e.g. `ffmpeg-newseries-1` |
...
| _id         | Object id created by MongoDB |
| id          | Auto increment id generated by Django |
| original_id | A combination of endpoint type, item type, and an auto-generated index, e.g. `ffmpeg-change1-1`, `ffmpeg-change2-1` |
...
| _id         | Object id created by MongoDB |
| id          | Auto increment id generated by Django |
| original_id | A combination of endpoint type, item type, and an auto-generated index, e.g. `ffmpeg-mailinglist-1` |
