...
Below is the correctness and Cohen's Kappa results of each approach applied to the selected five projects. (_N/A indicates both raters agree to exclude zero sampled groups_)

**Exact BoW grouping**

| Projects         | Correctness        | Agreement | Cohen's &kappa; | Interpretation |
| :--------------- | :----------------- | :-------- | :-------------- | :------------- |
| FFmpeg           | 97.80%(&plusmn;5%) | 100%      | N/A             | N/A            |
| QEMU             | 99.48%(&plusmn;5%) | 100%      | N/A             | N/A            |
| U-Boot           | 98.42%(&plusmn;5%) | 98.95%    | N/A             | N/A            |
| Linux Arm Kernel | 99.48%(&plusmn;5%) | 100%      | N/A             | N/A            |
| Netdev + BPF     | 98.41%(&plusmn;5%) | 96.81%    | N/A             | N/A            |

**One-word difference grouping**

| Projects         | Correctness        | Agreement | Cohen's &kappa; | Interpretation        |
| :--------------- | :----------------- | :-------- | :-------------- | :-------------------- |
| FFmpeg           | 82.27%(&plusmn;5%) | 91.43%    | 0.6809          | substantial agreement |
| QEMU             | 88.10%(&plusmn;5%) | 94.87%    | 0.7709          | substantial agreement |
| U-Boot           | 84.39%(&plusmn;5%) | 91.04%    | 0.7141          | substantial agreement |
| Linux Arm Kernel | 86.38%(&plusmn;5%) | 93.83%    | 0.7265          | substantial agreement |
| Netdev + BPF     | 82.95%(&plusmn;5%) | 92.59%    | 0.6301          | substantial agreement |

**Individual grouping**

| Projects         | Correctness        | Agreement | Cohen's &kappa; | Interpretation        |
| :--------------- | :----------------- | :-------- | :-------------- | :-------------------- |
| FFmpeg           | 81.94%(&plusmn;5%) | 88.89%    | 0.6786          | substantial agreement |
| QEMU             | 82.35%(&plusmn;5%) | 91.67%    | 0.7115          | substantial agreement |
| U-Boot           | 84.55%(&plusmn;5%) | 87.27%    | 0.5276          | moderate agreement    |
| Linux Arm Kernel | 82.47%(&plusmn;5%) | 94.52%    | 0.8016          | substantial agreement |
| Netdev + BPF     | 87.37%(&plusmn;5%) | 92.00%    | 0.4565          | moderate agreement    |
...
- _patchwork_project crawls patchwork projects and corresponding maintainer accounts data._
- _patchwork_series crawls patchwork series and corresponding series submitter accounts data._
- _patchwork_patch crawls patchwork patches, comments and corresponding submitter accounts data._
...
For filter type _exact_ and _-_, directly use the field name to filter. For example, `id=1`.

For filter type _icontains_, _gt_, and _lt_, the filter type with two underlines in the front has to be added right after the field name. For instance, `original_id__icontains=ffmpeg`.
