...
| maintainer_identity | Maintainers' corresponding identity data |
...
| mailinglist_original_id | Referencing the `original_id` in the mailinglists collection |
| series_original_id | Referencing the `original_id` in the series collection |
| newseries_original_id | Referencing the `original_id ` in the newseries collection |
| submitter_identity | Referencing the `original_id` in the accounts collection |
| submitter_individual | Referencing the `original_id ` in the users collection |
| project | Referencing the `original_id` in the projects collection |
