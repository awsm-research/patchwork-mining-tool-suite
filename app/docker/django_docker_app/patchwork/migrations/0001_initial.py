# Generated by Django 3.2.15 on 2023-01-02 16:33
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_original_id', models.CharField(blank=True, max_length=255, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Changes1',
            fields=[
                ...
                ('submitter_account_original_id', djongo.models.fields.JSONField(blank=True, null=True)),
                ('submitter_user_original_id', djongo.models.fields.JSONField(blank=True, null=True)),
                ('series_original_id', djongo.models.fields.JSONField(blank=True, null=True)),
                ('new_series_original_id', djongo.models.fields.JSONField(blank=True, null=True)),
                ('patch_original_id', djongo.models.fields.JSONField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reply_to_msg_id', djongo.models.fields.JSONField(blank=True, null=True)),
                ('web_url', models.CharField(blank=True, max_length=255, null=True)),
                ('change1_original_id', models.CharField(blank=True, max_length=255, null=True)),
                ('change2_original_id', models.CharField(blank=True, max_length=255, null=True)),
                ('mailing_list_original_id', models.CharField(blank=True, max_length=255, null=True)),
                ('submitter_account_original_id', models.CharField(blank=True, max_length=255, null=True)),
                ('submitter_user_original_id', models.CharField(blank=True, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('original_id', models.CharField(max_length=255, unique=True)),
                ('cover_letter_msg_id', djongo.models.fields.JSONField(blank=True, null=True)),
                ('project_original_id', models.CharField(blank=True, max_length=255, null=True)),
                ('submitter_account_original_id', djongo.models.fields.JSONField(blank=True, null=True)),
                ('submitter_user_original_id', djongo.models.fields.JSONField(blank=True, null=True)),
                ('series_original_id', djongo.models.fields.JSONField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('new_series_original_id', models.CharField(blank=True, max_length=255, null=True)),
                ('submitter_account_original_id', models.CharField(blank=True, max_length=255, null=True)),
                ('submitter_user_original_id', models.CharField(blank=True, max_length=255, null=True)),
                ('project_original_id', models.CharField(blank=True, max_length=255, null=True)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('maintainer_user_original_id', djongo.models.fields.JSONField(blank=True, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Series',
